...
;(function (root, factory) {
  ...
  PopupS.prototype = {
    ...
    _createPopup: function (item) {
      ...
      var contentObj = ((content instanceof Object))
    ...
    _loadContents: function (item) {
      ...
      var str = (typeof item.ajax.str !== 'undefined') ? item.ajax.str : ''
      var post = (typeof item.ajax.post !== 'undefined') ? item.ajax.post : true
      var self = this
